...
public class BubbleRelativeLayout extends RelativeLayout {
    ...
    public enum BubbleLegOrientation {
        TOP, LEFT, RIGHT, BOTTOM, NONE, DOUBLEVIEW
    }

    public static int CHILD_PADDING_LEFT = 30;
    public static int CHILD_PADDING_TOP = 30;
    public static int CHILD_PADDING_RIGHT = 30;
    public static int CHILD_PADDING_BOTTOM = 30;
    ...
    private void init(final Context context, final AttributeSet attrs) {
        ...
        if (attrs != null) {
            ...
            try {
                CHILD_PADDING_LEFT = a.getDimensionPixelSize(R.styleable.bubble_child_padding_left, CHILD_PADDING_LEFT);
                CHILD_PADDING_TOP = a.getDimensionPixelSize(R.styleable.bubble_child_padding_top, CHILD_PADDING_TOP);
                CHILD_PADDING_RIGHT = a.getDimensionPixelSize(R.styleable.bubble_child_padding_right, CHILD_PADDING_RIGHT);
                CHILD_PADDING_BOTTOM = a.getDimensionPixelSize(R.styleable.bubble_child_padding_bottom, CHILD_PADDING_BOTTOM);
        ...
        setPadding(CHILD_PADDING_LEFT, CHILD_PADDING_TOP, CHILD_PADDING_RIGHT, CHILD_PADDING_BOTTOM);
